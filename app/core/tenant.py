...
class TenantMiddleware(BaseHTTPMiddleware):
    ...
    async def _extract_tenant_from_jwt(self, request: Request) -> UUID | None:
        """
    ...
    async def _get_tenant_from_user(self, user_id: Any) -> UUID | None:
        """
...
def get_optional_tenant() -> UUID | None:
    """
