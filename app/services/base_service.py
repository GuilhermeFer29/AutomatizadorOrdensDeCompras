...
class BaseService(Generic[ModelT]):
    ...
    def __init__(self, session: AsyncSession):
        ...
        self._tenant_id: Optional[UUID] = TenantContext.get_current_tenant()
    ...
    def _apply_tenant_filter(self, query):
        ...
        if self._is_superuser:
            LOGGER.debug(f"Superuser mode: no tenant filter applied")
            return query
    ...
    def _validate_tenant_on_write(self, data: Union[ModelT, Dict]) -> None:
        """
    ...
    def _inject_tenant_on_create(self, data: Union[ModelT, Dict]) -> Union[ModelT, Dict]:
        """
    ...
    async def get_by_id(self, id: Any, include_relations: List[str] = None) -> Optional[ModelT]:
        """
    ...
    async def create(self, data: Union[ModelT, Dict[str, Any]]) -> ModelT:
        """
    ...
    async def create_many(self, items: List[Union[ModelT, Dict[str, Any]]]) -> List[ModelT]:
        """
