...
def test_create_supply_chain_team_structure():
    ...
    with patch("app.agents.supply_chain_team.get_gemini_for_fast_agents") as mock_fast, \
         patch("app.agents.supply_chain_team.get_gemini_for_reasoning_agents") as mock_reasoning:
