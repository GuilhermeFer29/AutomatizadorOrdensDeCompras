...
def get_task_status(task_id: str, current_user=Depends(get_current_user)) -> TaskStatusResponse:
    """
...
def list_models(current_user=Depends(get_current_user)) -> ModelsListResponse:
...
def get_available_targets(sku: str, current_user=Depends(get_current_user)) -> dict[str, Any]:
    """
...
def get_model_details(sku: str, current_user=Depends(get_current_user)) -> ModelInfoResponse:
...
def remove_model(sku: str, current_user=Depends(get_current_user)):
    """
